...
class CollectTrainingData(object):
    ...
    def __init__(self):
        ...
        self.server_socket.bind(('192.168.0.103', 8000))
    ...
    def collect_image(self):
        ...
        try:
            ...
            np.savez('training_data/data.npz', train=train, train_labels=train_labels)

            e2 = cv2.getTickCount()
            # calculate streaming duration
            time0 = (e2 - e1) / cv2.getTickFrequency()
            print('Streaming duration = {}'.format(time0))

            print(train.shape)
            print(train_labels.shape)
            print('Total frames = {}'.format(total_frame))
            print('Saved frames = {}'.format(saved_frame))
            print('Dropped frames = {}'.format(total_frame - saved_frame))
